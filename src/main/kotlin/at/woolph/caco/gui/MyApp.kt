...
private suspend fun appFonts(fonts: FontLoader): MyApp.AppFonts {
    ...
    return MyApp.AppFonts(body = bodyFont, header = headerFont, textField = textFieldFont, button = buttonFont)
}
