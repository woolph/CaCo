...
import at.woolph.caco.labels.box.ArtSeriesLabel
import at.woolph.caco.labels.box.AwaitingCatalogizationBoxLabel
import at.woolph.caco.labels.box.BlankBoxLabel
import at.woolph.caco.labels.box.BoxLabel
import at.woolph.caco.labels.box.CollectionBoxLabel
import at.woolph.caco.labels.box.DualSymbolBoxLabel
import at.woolph.caco.labels.box.DuplicateBoxLabel
import at.woolph.caco.labels.box.GenericBoxLabel
import at.woolph.caco.labels.box.MultipleSymbolBoxLabel
import at.woolph.caco.labels.box.OneSymbolBoxLabel
import at.woolph.caco.labels.box.PlanechaseBoxLabel
import at.woolph.caco.labels.box.ReturnToCollectionBoxLabel
import at.woolph.caco.labels.box.SnowCoveredBasicsAndWastes
import at.woolph.caco.labels.box.SubtitledDuplicateBoxLabel
                  ...
                  frame(margin, margin, margin, margin) {
                    when (columnItem) {
                      ...
                      is MultipleSymbolBoxLabel -> {
                        ...
                        columnItem.icons.forEachIndexed { i, nullableIcon ->
                          nullableIcon?.let { icon ->
                            ...
                            drawAsImageLeft(
                                createFromByteArray(
                                    icon,
                                    "MultipleSymbolBoxLabel(${columnItem.title}#$i)",
                                ),
                                iconWidth,
                                iconHeight,
                                width + displacingX,
  ...
  BoxLabels()
      .printLabel(
          ...
          listOf(
              ...
              //                  SubtitledDuplicateBoxLabel(subtitle = "Core Set 2021 Pt. I",
              // "m21"),
              //                  SubtitledDuplicateBoxLabel(subtitle = "Core Set 2021 Pt. II",
              // "m21"),
