...
class CardDetailsView(
  ...
  init {
    labelNumberInSet
        .textProperty()
        .bind(cardProperty.selectNullable { it?.collectorNumber }.toStringBinding())
    ...
    whenDocked {
      coroutineScope.launch(Dispatchers.Default) {
        combine(
            ...
            ) { cardModel, imageLoading ->
              Pair(cardModel, imageLoading)
            }
    ...
    whenUndocked { coroutineScope.coroutineContext.cancelChildren() }
  }
