...
open class PropertyHolder {
    companion object {
        ...
        fun <T> toCss(value: T): String = when (value) {
            ...
            is Enum<*> -> value.toString().lowercase(Locale.getDefault()).replace("_", "-")
...
internal fun String.camelToSnake() =
  (get(0).lowercaseChar() + substring(1)).replace(CssRule.upperCaseRegex, "-$1").lowercase(Locale.getDefault())
